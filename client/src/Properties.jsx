...
function Properties() {
  ...
  const getAllProperties = async () => {
   await  fetch('https://thg-seven.vercel.app/api/properties')
    .then(response =>  response.json()).then(data => setPropertyData(data))
  }
    ...
    <>
      <div className="page-wrapper">
        ...
        <div className="right-side">
          ...
          <Link to={`propertyDetail/${property.id}`} > <div className="prop_wrapper">
              <img
              ...
              <div className="display-section">
                ...
                <div className="flex-right property_flex_item">
                  <div className="column-flex">
                    ...
                    <h6 className="fin-amount">${property?.purchase_price}</h6>
                  </div>

                  <div className="column-flex ">
                    <h6 className="fin-text">CLOSING DATE</h6>

                    <h6 className="fin-amount">{property?.closing_date}</h6>
                  </div>
                </div>
                </div>
