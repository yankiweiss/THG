    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid d-flex justify-content-center gap-4">
          <li class="nav-item">
            <button type="button" class="btn btn-light btn-outline-secondary" onClick={() => navigate('/documents')}>
              Documents
            </button>
          </li>
          ...
          <li class="nav-item dropdown">
            <a
              class="nav-link dropdown-toggle border rounded p-2"
              href="#"
              role="button"
            ...
            <ul class="dropdown-menu" >
              <li value={'/addDeal'}>
                <button class="dropdown-item" onClick={() => navigate('/addDeal')}>
                  Sponsor
                </button>
              </li>
              <li>
